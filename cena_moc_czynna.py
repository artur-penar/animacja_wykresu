...
class DualAnimator:
    def __init__(self, fig, ax_top, ax_bot, x, series_df, top_cols, bottom_cols):
        ...
        ax_bot.set_ylabel("Wartość [zł]")
        ax_bot.set_xlabel("Czas" if self.is_time else "Indeks")
        ax_top.set_title("Moc czynna obiektu: " + ", ".join(top_cols))
        if bottom_cols:
            ax_bot.set_title("Cena energii: " + ", ".join(bottom_cols))
    ...
    def update_anim(self, i):
        ...
        if self.actual_top is not None:
            ...
            if len(self.top_cols) >= 2:
                ...
                self._fill_between_series(self.ax_top, xi, y_b, y_a, "top_between")
        ...
        if self.actual_bot is not None:
            ...
            if len(self.bottom_cols) >= 2:
                ...
                self._fill_between_series(self.ax_bot, xi, y_a, y_b, "bot_between")
